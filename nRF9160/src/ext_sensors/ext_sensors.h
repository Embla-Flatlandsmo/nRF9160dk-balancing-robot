...
#define GYRO_CHANNELS 3

BUILD_ASSERT(ACCELEROMETER_CHANNELS == GYRO_CHANNELS,
	     "Accelerometer channels (%d) and Gyro channels (%d) are different",
		 ACCELEROMETER_CHANNELS, GYRO_CHANNELS);
...
enum ext_sensor_evt_type
{
	...
	EXT_SENSOR_EVT_GYROSCOPE_ERROR,
};
